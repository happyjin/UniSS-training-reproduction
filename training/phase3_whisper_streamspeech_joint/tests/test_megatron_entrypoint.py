    ...
    def test_validation_requires_megatron_phase3_geometry(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            args = SimpleNamespace(
                ...
                joint_bridge_topk=8,
                joint_bridge_temperature=0.1,
                joint_trainable_whisper_pre_vq_layers=0,
                joint_bridge_commitment_weight=0.25,
                joint_whisper_quantize_weight=1.0,
                joint_teacher_glm_ce_weight=1.0,
                joint_teacher_glm_commitment_weight=1.0,
                ...
                joint_lr_bridge_mult=0.0,
                joint_lr_whisper_top_mult=0.05,
                joint_lr_whisper_bottom_mult=0.01,
                joint_lr_qwen_mult=0.01,
                joint_lr_qwen_io_mult=0.005,
