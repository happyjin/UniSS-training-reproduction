#!/usr/bin/env python3
"""Export and strictly evaluate the v6 parallel-semantic checkpoint."""
...
from web_demo.runtime_parity_streaming_v6.model_loader import load_runtime_models
...
def evaluate(args):
    ...
    summary["runtime_optimization"] = {
        "semantic_generation": "untied_natural_length_parallel_block_v1",
