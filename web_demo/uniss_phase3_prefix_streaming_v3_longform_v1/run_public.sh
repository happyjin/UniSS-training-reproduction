...
KERNEL_CACHE="${UNISS_PREFIX_LONGFORM_KERNEL_CACHE:-${USER_ROOT}/torch_kernel_cache}"
FFMPEG_BIN_DIR="${UNISS_PREFIX_LONGFORM_FFMPEG_BIN_DIR:-${REPO_ROOT}/web_demo/streaming_s2st_r2_v1/bin}"
