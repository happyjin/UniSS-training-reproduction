...
| First WRITE mean (model-frame ms) | 1440.0000 |
| First WRITE p50 (model-frame ms) | 1360.0000 |
| First WRITE p95 (model-frame ms) | 2640.0000 |
| Committed target unigram recall | 0.1462 |
| Source/target conflict events | 0 / 0 |
| Rollback events | 0 |

| Direction | Samples | WRITE coverage | First WRITE p50 ms | Recall |
| --- | ---: | ---: | ---: | ---: |
| EN→ZH | 32 | 1.0000 | 1360.0000 | 0.1462 |
