...
| --- | ---: |
| Samples | 32 |
| Samples with a WRITE | 0.9375 |
| First WRITE mean (model-frame ms) | 2382.6667 |
| First WRITE p50 (model-frame ms) | 1600.0000 |
| First WRITE p95 (model-frame ms) | 4880.0000 |
| Committed target unigram recall | 0.1802 |
...
| ZH→EN | 32 | 0.9375 | 1600.0000 | 0.1802 |
