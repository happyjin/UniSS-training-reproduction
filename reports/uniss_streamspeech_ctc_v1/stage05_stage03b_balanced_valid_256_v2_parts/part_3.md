...
| First WRITE mean (model-frame ms) | 1190.0000 |
| First WRITE p50 (model-frame ms) | 1200.0000 |
| First WRITE p95 (model-frame ms) | 1520.0000 |
| Committed target unigram recall | 0.1152 |
| Source/target conflict events | 0 / 0 |
| Rollback events | 0 |

| Direction | Samples | WRITE coverage | First WRITE p50 ms | Recall |
| --- | ---: | ---: | ---: | ---: |
| EN→ZH | 32 | 1.0000 | 1200.0000 | 0.1152 |
