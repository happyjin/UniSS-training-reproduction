...
| --- | ---: |
| Samples | 32 |
| Samples with a WRITE | 0.9062 |
| First WRITE mean (model-frame ms) | 2238.6207 |
| First WRITE p50 (model-frame ms) | 1680.0000 |
| First WRITE p95 (model-frame ms) | 5200.0000 |
| Committed target unigram recall | 0.1511 |
...
| ZH→EN | 32 | 0.9062 | 1680.0000 | 0.1511 |
