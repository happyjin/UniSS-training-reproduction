...
| --- | ---: |
| Samples | 256 |
| Samples with a WRITE | 0.9961 |
| First WRITE mean (model-frame ms) | 1202.5098 |
| First WRITE p50 (model-frame ms) | 1200.0000 |
| First WRITE p95 (model-frame ms) | 2000.0000 |
| Committed target unigram recall | 0.1473 |
| Source/target conflict events | 0 / 0 |
| Rollback events | 0 |

| Direction | Samples | WRITE coverage | First WRITE p50 ms | Recall |
| --- | ---: | ---: | ---: | ---: |
| EN→ZH | 256 | 0.9961 | 1200.0000 | 0.1473 |
