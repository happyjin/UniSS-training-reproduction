...
| First WRITE mean (model-frame ms) | 1840.0000 |
| First WRITE p50 (model-frame ms) | 1840.0000 |
| First WRITE p95 (model-frame ms) | 1840.0000 |
| Committed target unigram recall | 0.0952 |
| Source/target conflict events | 0 / 0 |
| Rollback events | 0 |

| Direction | Samples | WRITE coverage | First WRITE p50 ms | Recall |
| --- | ---: | ---: | ---: | ---: |
| EN→ZH | 1 | 1.0000 | 1840.0000 | 0.0952 |
