...
"${PYTHON_BIN}" -m \
  ...
  --initialization stage_a_formal_strict_resume \
  --resume-load "${RESUME_LOAD}"
...
export RUN_SAVE_DIR="${CHECKPOINT_ROOT}/stage_a_formal_resume/${RUN_ID}"
export RUN_TENSORBOARD_DIR="${RUN_ROOT}/stage_a_formal_resume/${RUN_ID}/tensorboard"
export RUN_LOG="${LOG_ROOT}/stage_a_formal_resume/${RUN_ID}/train.log"
