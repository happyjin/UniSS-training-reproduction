...
RUN_ID=${RUN_ID:-stage_a_v8_smoke2_$(date -u +%Y%m%dT%H%M%SZ)}
export RUN_ID
...
export RUN_TRAIN_ITERS=2
export RUN_CURRICULUM_ITERS=2
export RUN_OPTIMIZER_ITERS=2
export RUN_OPTIMIZER_WARMUP_ITERS=1
export RUN_MAX_ACOUSTICS=2
export RUN_NUM_WORKERS=4
export RUN_MASTER_PORT=${RUN_MASTER_PORT:-29736}
export RUN_SAVE_INTERVAL=2
export RUN_EVAL_INTERVAL=1
