...
echo "train_quality_gate=${REPORT_ROOT}/v1_rollouts/${FORMAL_RUN_ID}_train/QUALITY_GATE.json"
echo "valid_quality_gate=${REPORT_ROOT}/v1_rollouts/${FORMAL_RUN_ID}_valid/QUALITY_GATE.json"
