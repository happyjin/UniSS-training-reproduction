...
for name in DATA_RUN_ID LEARNING_ITERS LEARNING_MBS LEARNING_GBS \
  ...
  LEARNING_SEMANTIC_ROLLIN_END_WEIGHT \
  LEARNING_SEMANTIC_ROLLIN_END_MARGIN_WEIGHT \
  LEARNING_SEMANTIC_ROLLIN_CONTINUE_MARGIN_WEIGHT \
  LEARNING_SEMANTIC_ROLLIN_CONTINUE_LOGIT_MARGIN \
  LEARNING_SEMANTIC_ROLLIN_CONTINUE_TAIL \
  LEARNING_SEMANTIC_ROLLIN_CONTINUE_RATIO \
  LEARNING_SEMANTIC_CONTINUE_MARGIN_WEIGHT \
  LEARNING_SEMANTIC_CONTINUE_LOGIT_MARGIN \
  LEARNING_SEMANTIC_CONTINUE_TAIL \
