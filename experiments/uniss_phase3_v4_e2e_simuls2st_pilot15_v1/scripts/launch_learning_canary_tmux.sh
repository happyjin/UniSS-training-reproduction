...
for name in DATA_RUN_ID LEARNING_ITERS LEARNING_MBS LEARNING_GBS \
  ...
  LEARNING_SEMANTIC_ROLLIN_CONTINUE_DECISION_MARGIN_WEIGHT \
  LEARNING_SEMANTIC_ROLLIN_CONTINUE_DECISION_LOGIT_MARGIN \
  ...
  LEARNING_SEMANTIC_BOUNDARY_BINARY_WEIGHT \
  LEARNING_SEMANTIC_BOUNDARY_BINARY_LOGIT_MARGIN \
