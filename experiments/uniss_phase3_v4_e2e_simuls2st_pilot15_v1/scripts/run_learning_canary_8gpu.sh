...
LEARNING_SEMANTIC_ROLLIN_END_WEIGHT=${LEARNING_SEMANTIC_ROLLIN_END_WEIGHT:-0.0}
LEARNING_SEMANTIC_ROLLIN_END_MARGIN_WEIGHT=${LEARNING_SEMANTIC_ROLLIN_END_MARGIN_WEIGHT:-0.0}
LEARNING_SEMANTIC_CONTINUE_MARGIN_WEIGHT=${LEARNING_SEMANTIC_CONTINUE_MARGIN_WEIGHT:-0.0}
LEARNING_SEMANTIC_CONTINUE_LOGIT_MARGIN=${LEARNING_SEMANTIC_CONTINUE_LOGIT_MARGIN:-0.0}
LEARNING_SEMANTIC_CONTINUE_TAIL=${LEARNING_SEMANTIC_CONTINUE_TAIL:-12}
LEARNING_SEMANTIC_PREFIX_CORRUPTION_RATE=${LEARNING_SEMANTIC_PREFIX_CORRUPTION_RATE:-0.0}
LEARNING_SEMANTIC_PREFIX_CORRUPTION_TAIL=${LEARNING_SEMANTIC_PREFIX_CORRUPTION_TAIL:-8}
LEARNING_SEMANTIC_PREFIX_CORRUPTION_RAMP_UPDATES=${LEARNING_SEMANTIC_PREFIX_CORRUPTION_RAMP_UPDATES:-0}
LEARNING_SEMANTIC_BOUNDARY_ROLLIN_RATE=${LEARNING_SEMANTIC_BOUNDARY_ROLLIN_RATE:-0.0}
LEARNING_SEMANTIC_BOUNDARY_ROLLIN_RAMP_UPDATES=${LEARNING_SEMANTIC_BOUNDARY_ROLLIN_RAMP_UPDATES:-0}
...
env \
  ...
  RUN_SEMANTIC_ROLLIN_END_WEIGHT="${LEARNING_SEMANTIC_ROLLIN_END_WEIGHT}" \
  RUN_SEMANTIC_ROLLIN_END_MARGIN_WEIGHT="${LEARNING_SEMANTIC_ROLLIN_END_MARGIN_WEIGHT}" \
  RUN_SEMANTIC_CONTINUE_MARGIN_WEIGHT="${LEARNING_SEMANTIC_CONTINUE_MARGIN_WEIGHT}" \
  RUN_SEMANTIC_CONTINUE_LOGIT_MARGIN="${LEARNING_SEMANTIC_CONTINUE_LOGIT_MARGIN}" \
  RUN_SEMANTIC_CONTINUE_TAIL="${LEARNING_SEMANTIC_CONTINUE_TAIL}" \
  RUN_SEMANTIC_PREFIX_CORRUPTION_RATE="${LEARNING_SEMANTIC_PREFIX_CORRUPTION_RATE}" \
  RUN_SEMANTIC_PREFIX_CORRUPTION_TAIL="${LEARNING_SEMANTIC_PREFIX_CORRUPTION_TAIL}" \
  RUN_SEMANTIC_PREFIX_CORRUPTION_RAMP_UPDATES="${LEARNING_SEMANTIC_PREFIX_CORRUPTION_RAMP_UPDATES}" \
  RUN_SEMANTIC_BOUNDARY_ROLLIN_RATE="${LEARNING_SEMANTIC_BOUNDARY_ROLLIN_RATE}" \
  RUN_SEMANTIC_BOUNDARY_ROLLIN_RAMP_UPDATES="${LEARNING_SEMANTIC_BOUNDARY_ROLLIN_RAMP_UPDATES}" \
