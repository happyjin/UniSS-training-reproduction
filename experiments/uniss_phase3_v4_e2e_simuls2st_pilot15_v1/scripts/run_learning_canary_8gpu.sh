...
LEARNING_SEMANTIC_ROLLIN_CONTINUE_DECISION_MARGIN_WEIGHT=${LEARNING_SEMANTIC_ROLLIN_CONTINUE_DECISION_MARGIN_WEIGHT:-0.0}
LEARNING_SEMANTIC_ROLLIN_CONTINUE_DECISION_LOGIT_MARGIN=${LEARNING_SEMANTIC_ROLLIN_CONTINUE_DECISION_LOGIT_MARGIN:-0.0}
LEARNING_SEMANTIC_ROLLIN_CONTINUE_MARGIN_WEIGHT=${LEARNING_SEMANTIC_ROLLIN_CONTINUE_MARGIN_WEIGHT:-0.0}
LEARNING_SEMANTIC_ROLLIN_CONTINUE_LOGIT_MARGIN=${LEARNING_SEMANTIC_ROLLIN_CONTINUE_LOGIT_MARGIN:-0.0}
LEARNING_SEMANTIC_ROLLIN_CONTINUE_TAIL=${LEARNING_SEMANTIC_ROLLIN_CONTINUE_TAIL:-12}
LEARNING_SEMANTIC_ROLLIN_CONTINUE_RATIO=${LEARNING_SEMANTIC_ROLLIN_CONTINUE_RATIO:-0.5}
...
LEARNING_SEMANTIC_BOUNDARY_BINARY_WEIGHT=${LEARNING_SEMANTIC_BOUNDARY_BINARY_WEIGHT:-0.0}
LEARNING_SEMANTIC_BOUNDARY_BINARY_LOGIT_MARGIN=${LEARNING_SEMANTIC_BOUNDARY_BINARY_LOGIT_MARGIN:-0.0}
...
env \
  ...
  RUN_SEMANTIC_ROLLIN_CONTINUE_DECISION_MARGIN_WEIGHT="${LEARNING_SEMANTIC_ROLLIN_CONTINUE_DECISION_MARGIN_WEIGHT}" \
  RUN_SEMANTIC_ROLLIN_CONTINUE_DECISION_LOGIT_MARGIN="${LEARNING_SEMANTIC_ROLLIN_CONTINUE_DECISION_LOGIT_MARGIN}" \
  RUN_SEMANTIC_ROLLIN_CONTINUE_MARGIN_WEIGHT="${LEARNING_SEMANTIC_ROLLIN_CONTINUE_MARGIN_WEIGHT}" \
  RUN_SEMANTIC_ROLLIN_CONTINUE_LOGIT_MARGIN="${LEARNING_SEMANTIC_ROLLIN_CONTINUE_LOGIT_MARGIN}" \
  RUN_SEMANTIC_ROLLIN_CONTINUE_TAIL="${LEARNING_SEMANTIC_ROLLIN_CONTINUE_TAIL}" \
  RUN_SEMANTIC_ROLLIN_CONTINUE_RATIO="${LEARNING_SEMANTIC_ROLLIN_CONTINUE_RATIO}" \
  ...
  RUN_SEMANTIC_BOUNDARY_BINARY_WEIGHT="${LEARNING_SEMANTIC_BOUNDARY_BINARY_WEIGHT}" \
  RUN_SEMANTIC_BOUNDARY_BINARY_LOGIT_MARGIN="${LEARNING_SEMANTIC_BOUNDARY_BINARY_LOGIT_MARGIN}" \
