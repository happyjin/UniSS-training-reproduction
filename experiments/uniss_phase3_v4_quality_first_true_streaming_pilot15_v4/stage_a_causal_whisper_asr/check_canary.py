#!/usr/bin/env python3
"""Authorize formal v4 only after the final 160-ms canary validation passes."""
...
FINAL_SAVE = re.compile(r"successfully saved checkpoint from iteration\s+127\b")
...
def evaluate(text: str) -> dict[str, object]:
    ...
    return {
        "schema_version": "uniss_stage_a_v4_canary_gate_v1",
