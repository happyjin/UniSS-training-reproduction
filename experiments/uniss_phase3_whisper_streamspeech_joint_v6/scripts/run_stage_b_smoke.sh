...
export RUN_NAME="${RUN_NAME:-phase3_joint_v6_stage_b_guarded_joint_smoke_v2}"
...
export LOAD_DIR="${LOAD_DIR:-${REPO_ROOT}/checkpoints/uniss_phase3_whisper_streamspeech_joint_v6/phase3_joint_v6_stage_a_heads_only_smoke_v2}"
