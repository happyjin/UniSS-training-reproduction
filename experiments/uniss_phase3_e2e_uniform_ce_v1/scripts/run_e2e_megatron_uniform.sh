...
# The one weight the established launcher never passes, so it has always taken
# the CLI default of 0.10.  Boundary tokens are 32.8% of supervised tokens in
# the interleaved family and receive 4.7% of the gradient at that value.
RUN_BOUNDARY_EOS_WEIGHT=${RUN_BOUNDARY_EOS_WEIGHT:-0.10}
