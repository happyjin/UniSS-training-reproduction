...
DATA=${REPO_ROOT}/data/processed/uniss_phasea_event_constrained_grpo_long_v2/${PACK_ID}
TRAIN=${DATA}/train_packs.jsonl
VALID=${DATA}/valid_packs.jsonl
SAVE=${REPO_ROOT}/checkpoints/uniss_phasea_event_constrained_grpo_long_v2/${RUN_ID}
TB=${REPO_ROOT}/runs/uniss_phasea_event_constrained_grpo_long_v2/tensorboard/${RUN_ID}
LOG=${REPO_ROOT}/logs/uniss_phasea_event_constrained_grpo_long_v2/${RUN_ID}.log
...
CMD=(
  ...
  "${EXPERIMENT_ROOT}/training/pretrain_event_grpo.py"
