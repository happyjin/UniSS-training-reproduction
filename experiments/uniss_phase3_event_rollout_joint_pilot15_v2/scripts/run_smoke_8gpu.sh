...
SMOKE_NAME="${SMOKE_NAME:-uniss_phase3_event_rollout_joint_pilot15_v2_smoke8_v1}"
SMOKE_ROOT="${REPO_ROOT}/data/megatron/uniss_phase3_event_rollout_joint_pilot15_v2/smoke8_v1"
...
"${PYTHON}" -m experiments.uniss_phase3_event_rollout_joint_pilot15_v1.data.build_training_manifest \
  ...
  --replay-offsets "${REPO_ROOT}/data/megatron/uniss_true_subsecond_pilot15_v1/packed_replay.offsets.u64" \
...
export MASTER_PORT="${SMOKE_MASTER_PORT:-29923}"
