...
PROBE_VALID_SAMPLES_PER_DIRECTION="${PROBE_VALID_SAMPLES_PER_DIRECTION:-4}"
PROBE_TRAIN_SAMPLES_PER_DIRECTION="${PROBE_TRAIN_SAMPLES_PER_DIRECTION:-4}"
PROBE_RETENTION_SAMPLES_PER_DIRECTION="${PROBE_RETENTION_SAMPLES_PER_DIRECTION:-4}"
