...
RESUME="$ROOT/checkpoints/uniss_streamspeech_ctc_v1/stage03_multitask_encoder_bucket_v2/latest_resume.pt"
LENGTHS="$ROOT/data/processed/uniss_streamspeech_ctc_v1/stage03_multitask_encoder/train_lengths.u32"
OUTPUT="$ROOT/checkpoints/uniss_streamspeech_ctc_v1/stage03_multitask_encoder_bucket_b32_v3"
TENSORBOARD="$ROOT/runs/uniss_streamspeech_ctc_v1/stage03_multitask_encoder_bucket_b32_v3"
