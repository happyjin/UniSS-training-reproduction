...
OUTPUT="$ROOT/checkpoints/uniss_streamspeech_ctc_v1/stage03_multitask_encoder_v1"
TENSORBOARD="$ROOT/runs/uniss_streamspeech_ctc_v1/stage03_multitask_encoder_v1"
