...
"$PYTHON" -m torch.distributed.run --nproc_per_node=8 --master_port=29641 \
  ...
  --output-dir "$ROOT/checkpoints/uniss_streamspeech_ctc_v1/stage03b_ar_s2tt_b16_v3" \
  --tensorboard-dir "$ROOT/runs/uniss_streamspeech_ctc_v1/stage03b_ar_s2tt_b16_v3" \
  --batch-size 16 \
  --max-steps 5000 \
  --eval-every 500
