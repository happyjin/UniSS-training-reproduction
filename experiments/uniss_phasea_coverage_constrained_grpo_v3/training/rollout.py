...
def main() -> None:
    ...
    try:
                ...
                for candidate in candidates:
                    for trace_index, trace in enumerate(candidate.pop("traces")):
                        trajectory_file.write(
                            json.dumps(
                                {
                                    "schema_version": "uniss_coverage_constrained_trajectory_v3",
        ...
        controller.close()
    payload = {
        "schema_version": "uniss_coverage_constrained_rollout_v3",
        "status": "complete",
        "round_index": args.round_index,
        ...
        "route_semantics": "asr_frozen_adapter_on_control_mt_tts_coverage_first",
