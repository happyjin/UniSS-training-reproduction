#!/usr/bin/env python3
"""Strict real-PCM evaluation for fixed15 event-rollout checkpoints."""
...
def evaluate(args):
    ...
    summary["schema_version"] = "uniss_event_rollout_fixed15_pcm_evaluation_v1"
    summary["runtime_training"] = {
        "version": "uniss_phase3_event_rollout_joint_pilot15_v1",
