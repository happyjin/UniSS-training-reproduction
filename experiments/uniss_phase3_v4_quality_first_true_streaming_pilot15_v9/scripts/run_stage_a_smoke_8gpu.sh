...
RUN_ID=${RUN_ID:-stage_a_v9_smoke2_$(date -u +%Y%m%dT%H%M%SZ)}
...
export RUN_PREFIX_SCHEDULE=1 RUN_TRAIN_ITERS=2 RUN_CURRICULUM_ITERS=2
export RUN_OPTIMIZER_ITERS=2 RUN_OPTIMIZER_WARMUP_ITERS=1
export RUN_MAX_ACOUSTICS=2 RUN_NUM_WORKERS=4 RUN_MASTER_PORT=${RUN_MASTER_PORT:-29737}
export RUN_SAVE_INTERVAL=2 RUN_EVAL_INTERVAL=1 RUN_EVAL_ITERS=1 RUN_LOG_INTERVAL=1
