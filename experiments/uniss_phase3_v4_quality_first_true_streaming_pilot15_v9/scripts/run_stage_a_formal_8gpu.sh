...
if (
    ...
    raise SystemExit("Stage A V9 bridge-freeze canary has not authorized formal")
PY

RUN_ID=${RUN_ID:-stage_a_v9_formal8_$(date -u +%Y%m%dT%H%M%SZ)}
export RUN_ID
...
export RUN_MASTER_PORT=${RUN_MASTER_PORT:-29738}
