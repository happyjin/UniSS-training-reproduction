...
RUN_ID=${RUN_ID:-stage_a_v9_bridgefreeze128_canary8_$(date -u +%Y%m%dT%H%M%SZ)}
export RUN_ID
export RUN_ENTRYPOINT="${V9_ENTRYPOINT}"
export RUN_COMPILE_NAMESPACE=stage_a_v9_compile
...
export RUN_SAVE_DIR="${CHECKPOINT_ROOT}/stage_a_bridge_freeze_canary/${RUN_ID}"
export RUN_TENSORBOARD_DIR="${RUN_ROOT}/stage_a_bridge_freeze_canary/${RUN_ID}/tensorboard"
export RUN_LOG="${LOG_ROOT}/stage_a_bridge_freeze_canary/${RUN_ID}/train.log"
...
export RUN_MASTER_PORT=${RUN_MASTER_PORT:-29737}
