#!/usr/bin/env bash
# Waits for a speak-decision training run to report complete, then exports the
...
TRAIN_SUMMARY=${TRAIN_REPORT_ROOT}/SPEAK_DECISION_RUN.json
