...
TRAIN_DATA="${TRAIN_DATA:-${REPO_ROOT}/data/megatron/phase1_unist13/packed_train.jsonl}"
VALID_DATA="${VALID_DATA:-}"
LOAD_CHECKPOINT="${LOAD_CHECKPOINT:-${REPO_ROOT}/checkpoints/qwen2_0p5b_uniss_vocab}"
...
cmd=(torchrun
  ...
  --train-iters "${TRAIN_ITERS:-1269}"
  --lr 8e-4
  --min-lr 8e-4
  --lr-warmup-iters "${LR_WARMUP_ITERS:-423}"
