...
TRAIN_DATA="${TRAIN_DATA:-${REPO_ROOT}/data/megatron/phase2_mix/packed_train.jsonl}"
VALID_DATA="${VALID_DATA:-}"
LOAD_CHECKPOINT="${LOAD_CHECKPOINT:-${REPO_ROOT}/checkpoints/uniss_phase1}"
SAVE_DIR="${SAVE_DIR:-${REPO_ROOT}/checkpoints/uniss_phase2}"
...
cmd=(torchrun
  ...
  --train-iters "${TRAIN_ITERS:-23872}"
  --lr 2e-4
  --min-lr 2e-4
  --lr-warmup-iters "${LR_WARMUP_ITERS:-1194}"
